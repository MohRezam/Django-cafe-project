...
urlpatterns = [
    ...
    path('statistics/',views.SalesStatisticsView.as_view(),name="statistics"),
    path('download-csv/', views.DownloadCSVView.as_view(), name='download_csv'),
     path('view-sales-statistics/', views.sales_statistics_view, name='view_sales_statistics')
